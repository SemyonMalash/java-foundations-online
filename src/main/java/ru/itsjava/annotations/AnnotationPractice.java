...
//        System.out.println(ivan);
        ...
        BiologyStudent biologyStudent = new BiologyStudent();

        Field name = mathStudent.getClass().getDeclaredField("name");
        name.setAccessible(true);
        name.set(mathStudent, "Дмитрий");

        System.out.println(mathStudent.getName() + ": " + mathStudent.getClass().getAnnotation(Department.class).name());
        System.out.println(biologyStudent.getName() + ": " + biologyStudent.getClass().getAnnotation(Department.class).name());
    }
}
